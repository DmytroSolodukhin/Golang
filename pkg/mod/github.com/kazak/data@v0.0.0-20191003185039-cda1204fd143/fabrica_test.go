...
//		go model.ScanRequestBodyToChank(scanner, chankText)
//
...
//		chankText, chankPort := make(chan string), make(chan *model.Port)
//		jsonPort := `"Test": {
//			"name": "test",
//			"city": "test",
//			"country": "test",
...
//			Code: "52000",
//		}
//		go model.StartProdactionPort(chankText, chankPort)
//
//		Convey("Getting chanks", func() {
//			go func() {
//				chankText <- "{"
